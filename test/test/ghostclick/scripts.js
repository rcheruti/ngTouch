Module.controller('GhostClick',['$scope','$element','$swipe',
  ...
  var config = {preventMouseFromTouch:true, preventDuration: $scope.tempoPrevent};
  var swiper1 = $swipe.bind( p1, {
    start:function(pos, ev){
      console.log('hello1', ev); p2.removeClass('getout');
      //ev.stopPropagation();
      //ev.preventDefault();
    }
  }, config  );
  var swiper2 = $swipe.bind( p2, {
    start:function(pos, ev){
      console.log('hello2', ev); p2.addClass('getout');
      //ev.stopPropagation();
      //ev.preventDefault();
    }
  }, config );
